...
For ($i=0; $i -lt $instances.Length; $i++) {
    ...
    Start-Process -FilePath "C:\Program Files\BlueStacks_bgp64\Bluestacks.exe" -ArgumentList "-vmname $instance", '-json "{\"app_icon_url\":\"\",\"app_name\":\"Grindr\",\"app_url\":\"\",\"app_pkg\":\"com.grindrapp.android\"}"'
